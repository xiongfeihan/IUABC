...
document.createElement("canvas").getContext || (function () {
    ...
    i.stroke = function (b) {
        ...
        if (b) if (typeof this.fillStyle == "object") {
            ...
            if (m.type_ == "gradient") {
                var t = m.x1_ / this.arcScaleX_, E = m.y1_ / this.arcScaleY_,
            ...
            var J = u.length, da = u[0].color, ea = u[J - 1].color, fa = u[0].alpha * this.globalAlpha,
                ga = u[J - 1].alpha * this.globalAlpha, S = [], l = 0;
            for (; l < J; l++) {
                var T = u[l];
                S.push(T.offset * q +
                    o + " " + T.color)

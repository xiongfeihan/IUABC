        ...
        <div class="right_col" role="main">
            <div class="row tile_count">
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-home"></i> 车间号 No.</span>
                    <div class="count">${workshop.workshopId}</div>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-arrows-h"></i> 长 / Length</span>
                    <div class="count green">${workshop.length}</div>
                    <span class="count_bottom"> 米 / meters</span>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-arrows-h"></i> 宽 / Width</span>
                    <div class="count green">${workshop.width}</div>
                    <span class="count_bottom"> 米 / meters</span>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                    <span class="count_top"><i class="fa fa-arrows-v"></i> 高 / Height</span>
                    <div class="count green">${workshop.height}</div>
                    <span class="count_bottom"> 米 / meters</span>
                </div>
                <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
...
<script type="text/javascript">
    ...
    // 此处应该由后台返回车间参数（放大50倍）
    var radio = 50;
    var DEPARTMENT_LENGTH = ${workshop.length} * radio;
    var DEPARTMENT_WIDTH = ${workshop.width} * radio;
    var DEPARTMENT_HEIGHT = ${workshop.height} * radio;
